...
class MainWindowViewStateMixin:
    ...
    def _refresh_pipeline_controls(self) -> None:
        ...
        approval_mode_enabled = not busy
        if hasattr(self, "pipeline_manual_approval_radio"):
            self.pipeline_manual_approval_radio.setEnabled(approval_mode_enabled)
            self.pipeline_auto_approval_radio.setEnabled(approval_mode_enabled)
