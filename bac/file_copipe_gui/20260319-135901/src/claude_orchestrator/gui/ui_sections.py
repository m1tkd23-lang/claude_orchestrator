...
def build_execution_tab(window: Any) -> QWidget:
    ...
    right_layout.addWidget(build_remote_control_group(window))
...
def build_remote_control_group(window: Any) -> QGroupBox:
    ...
    window.remote_last_message_edit.setFixedHeight(90)
    ...
    layout.addWidget(window.remote_status_edit, 3, 1)
    layout.addWidget(QLabel("mode"), 4, 0)
    layout.addWidget(window.remote_mode_edit, 4, 1)
    layout.addWidget(QLabel("last_started_at"), 5, 0)
    layout.addWidget(window.remote_last_started_at_edit, 5, 1)
    layout.addWidget(QLabel("bridge_url"), 6, 0)
    layout.addWidget(window.remote_bridge_url_edit, 6, 1)
    layout.addWidget(QLabel("console_log_path"), 7, 0)
    layout.addWidget(window.remote_console_log_path_edit, 7, 1)
    layout.addWidget(QLabel("server_pid"), 8, 0)
    layout.addWidget(window.remote_server_pid_edit, 8, 1)
    layout.addWidget(QLabel("current_menu"), 9, 0)
    layout.addWidget(window.remote_current_menu_edit, 9, 1)
    layout.addWidget(QLabel("previous_menu"), 10, 0)
    layout.addWidget(window.remote_previous_menu_edit, 10, 1)
    layout.addWidget(QLabel("selected_task_id"), 11, 0)
    layout.addWidget(window.remote_selected_task_id_edit, 11, 1)
    layout.addWidget(QLabel("selected_source_task_id"), 12, 0)
    layout.addWidget(window.remote_selected_source_task_id_edit, 12, 1)
    layout.addWidget(QLabel("selected_proposal_id"), 13, 0)
    layout.addWidget(window.remote_selected_proposal_id_edit, 13, 1)
    layout.addWidget(QLabel("last_message"), 14, 0)
    layout.addWidget(window.remote_last_message_edit, 14, 1)
    layout.addLayout(button_row, 15, 0, 1, 2)
