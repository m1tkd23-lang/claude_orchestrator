...
def load_selected_task_detail(window, task_id: str) -> None:
    ...
    window.detail_task_id.setText(str(detail.get("task_id", "")))
    window.detail_title.setText(str(detail.get("title", "")))
    window.detail_description.setPlainText(str(detail.get("description", "")))
    window.detail_status.setText(str(detail.get("status", "")))
    window.detail_current_stage.setText(str(detail.get("current_stage", "")))
    window.detail_next_role.setText(str(detail.get("next_role", "")))
    window.detail_cycle.setText(str(detail.get("cycle", "")))
    window.detail_last_completed_role.setText(
        str(detail.get("last_completed_role", ""))
    )
    window.detail_max_cycles.setText(str(detail.get("max_cycles", "")))
    window.detail_task_dir.setText(str(detail.get("task_dir", "")))
