...
def set_task_detail(window: Any, data: dict[str, Any]) -> None:
    window.detail_task_id.setText(str(data.get("task_id", "")))
    window.detail_title.setText(str(data.get("title", "")))
    window.detail_description.setPlainText(str(data.get("description", "")))
    window.detail_status.setText(str(data.get("status", "")))
    window.detail_current_stage.setText(str(data.get("current_stage", "")))
    window.detail_next_role.setText(str(data.get("next_role", "")))
    window.detail_cycle.setText(str(data.get("cycle", "")))
    ...
    window._current_task_id = str(data.get("task_id", ""))
