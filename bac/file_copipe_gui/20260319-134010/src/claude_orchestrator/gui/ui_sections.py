...
def build_remote_control_group(window: Any) -> QGroupBox:
    ...
    for widget in [
        window.remote_session_name_edit,
    ...
    layout.addWidget(window.remote_status_edit, 1, 1)
    layout.addWidget(QLabel("mode"), 2, 0)
    layout.addWidget(window.remote_mode_edit, 2, 1)
    layout.addWidget(QLabel("last_started_at"), 3, 0)
    layout.addWidget(window.remote_last_started_at_edit, 3, 1)
    layout.addWidget(QLabel("current_menu"), 4, 0)
    layout.addWidget(window.remote_current_menu_edit, 4, 1)
    layout.addWidget(QLabel("previous_menu"), 5, 0)
    layout.addWidget(window.remote_previous_menu_edit, 5, 1)
    layout.addWidget(QLabel("selected_task_id"), 6, 0)
    layout.addWidget(window.remote_selected_task_id_edit, 6, 1)
    layout.addWidget(QLabel("selected_source_task_id"), 7, 0)
    layout.addWidget(window.remote_selected_source_task_id_edit, 7, 1)
    layout.addWidget(QLabel("selected_proposal_id"), 8, 0)
    layout.addWidget(window.remote_selected_proposal_id_edit, 8, 1)
    layout.addWidget(QLabel("last_message"), 9, 0)
    layout.addWidget(window.remote_last_message_edit, 9, 1)
    layout.addLayout(button_row, 10, 0, 1, 2)
