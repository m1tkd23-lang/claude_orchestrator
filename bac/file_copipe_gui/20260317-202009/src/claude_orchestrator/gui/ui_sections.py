...
def build_action_group(window: Any) -> QGroupBox:
    ...
    execution_row.addWidget(QLabel("execution status"), 0, 0)
    execution_row.addWidget(window.execution_status_edit, 0, 1)
    execution_row.addWidget(QLabel("current step"), 1, 0)
    execution_row.addWidget(window.execution_step_edit, 1, 1)
    execution_row.addWidget(QLabel("current role"), 2, 0)
    execution_row.addWidget(window.execution_role_edit, 2, 1)
    execution_row.addWidget(QLabel("current cycle"), 3, 0)
    execution_row.addWidget(window.execution_cycle_edit, 3, 1)

    window.execution_summary_edit = QPlainTextEdit()
    window.execution_summary_edit.setReadOnly(True)
    window.execution_summary_edit.setFixedHeight(100)
    ...
    layout.addWidget(window.execution_summary_edit)
